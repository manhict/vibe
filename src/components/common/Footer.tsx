...
function Footer() {
  return (
    <footer className="border max-xl:w-10/12 max-lg:w-10/12 max-sm:w-full max-md:hidden backdrop-blur-lg  select-none w-7/12 p-3 rounded-xl px-5 z-40 border-[#49454F] flex items-center justify-between ">
