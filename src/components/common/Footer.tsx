...
function Footer() {
  return (
    <footer className="border max-xl:w-9/12 max-2xl:w-9/12 max-sm:w-9/12 max-lg:w-11/12 max-md:hidden backdrop-blur-lg  select-none w-7/12 p-3 rounded-xl px-5 z-40 border-[#49454F] flex items-center justify-between ">
