...
function Reconnect() {
  ...
  return (
    <div className=" w-full inset-0 max-md:px-5 max-md:text-lg text-zinc-200 h-screen bg-black/70 backdrop-blur-sm z-50 absolute flex items-center flex-col justify-center font-semibold text-xl">
      <p>
        (
