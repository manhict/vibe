    ...
    <>
      ...
      <AnimatePresence>
        {!socketRef.current?.connected && (
          <motion.div
            className="w-full inset-0 max-md:px-5 max-md:text-xl text-zinc-200 h-screen bg-black/70 backdrop-blur-xl z-50 absolute flex items-center flex-col justify-center font-semibold text-2xl"
            initial="hidden"
            animate="visible"
            exit="exit"
      ...
      >
        ...
        <div className="max-md:w-full max-md:gap-0 h-full z-40 flex-wrap flex overflow-hidden max-xl:w-11/12 max-lg:w-11/12 max-sm:w-full max-md:overflow-scroll hide-scrollbar py-4 max-md:py-0 gap-3 w-7/12">
          <Player />
