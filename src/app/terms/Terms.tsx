          ...
          <article className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-100">
                ...
                educational purposes. Please read these Terms of Service
                carefully before using Vibe. By accessing or using the Vibe app,
            ...
            <section>
              ...
              <p className="text-gray-100">
                ...
                application created for educational purposes only. The app
                allows users to vote on songs in a shared queue and engage in a
                chat room with other users. Vibe is not intended for commercial
                use, and all content and features are strictly for learning and
            ...
            <section>
              ...
              <p className="text-gray-100">
                By using Vibe, you represent that you are at least 18 years of
                age or have the consent of a parent or guardian, and you agree
                to comply with these terms. Users under the age of 18 should use
                this app with parental supervision.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-100">
                Vibe includes features that allow users to chat and vote on
                songs. By participating in chat and voting:
              </p>
              <ul className="list-disc pl-4 text-gray-100 space-y-2">
                <li>
                  You agree to keep interactions respectful and refrain from
                ...
                <li>
                  Vibe reserves the right to remove or restrict access to
            ...
            <section>
              ...
              <p className="text-gray-100">
                ...
                want to hear next. The song with the highest number of votes
                will be played next in the queue.
              </p>
              <ul className="list-disc pl-4 mt-2 text-gray-100 space-y-1.5">
                <li>
                  Voting is limited to the songs available in the queue, and
                  users may vote only on one song at a time.
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-gray-100">
                Vibe respects user privacy and is designed to collect minimal
                data necessary for its functionality.
              </p>
              <ul className="list-disc pl-4 text-gray-100 space-y-2">
                <li>
            ...
            <section>
              ...
              <p className="text-gray-100">
                ...
                held liable for any damages resulting from the use of or
                inability to use the app.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold">8. Amendments</h2>
              <p className="text-gray-100">
                Vibe may update these Terms of Service from time to time. Users
                will be notified of any changes through an in-app notification
                or a message.
              </p>
            </section>
